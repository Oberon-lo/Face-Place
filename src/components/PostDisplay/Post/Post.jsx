...
const Post = (props) => {
    const { user_id, first_name, last_name, prof_pic, post_id, postcont } = props.post;
    ...
    function postDeleter() {
        axios
            .delete(`/post/${post_id}`)
            .then(response => {
                // ! TODO: add sweet alert for response.data.message
            ...
            <div className="post-content">
                {edit
                    ...
                    <div className="post-info">
                        ...
                        <input value={post_cont} onChange={(e) => setPost_cont(e.target.value)} type="text" />
                    </div>
                    :
                    <div className="post-info">
            ...
            <div className="comment-section">
                ...
                {comArr.map((comment, i) => (
                    <div key={i} className="comment-container">
                        <Comment index={i} com={comment} comArr={comArr} editComArr={addComArr} />
                    </div>
                ))}
                <ComMaker comArr={comArr} addComArr={addComArr} post_id={post_id} setComCount={setComCount} comCount={comCount} />
            </div>
        </div>
    );
};
